...
def make_DBL_cluster(in_channels,
                     cluster_num=3,
                     norm_type='BN',
                     num_groups=None,
                     sam=False):
    ...
    for i in range(cluster_num):
        ...
        clusters.append(
            DarknetConv2D_Norm_Activation(in_c, out_c,
...
class UpSampleModule(nn.Module):
    def __init__(self,
        ...
        self.conv1x1_1 = DarknetConv2D_Norm_Activation(in_channels,
                                                       in_channels // 2,
                                                       kernel_size=1,
                                                       activation='leaky',
                                                       norm_type=norm_type,
                                                       num_groups=num_groups)
        self.conv1x1_2 = DarknetConv2D_Norm_Activation(in_channels,
                                                       in_channels // 2,
                                                       kernel_size=1,
                                                       activation='leaky',
                                                       norm_type=norm_type,
                                                       num_groups=num_groups)
        dbl_clusters = make_DBL_cluster(in_channels,
                                        cluster_num=5,
                                        norm_type=norm_type,
                                        num_groups=num_groups,
                                        sam=sam)
...
class DownSampleModule(nn.Module):
    def __init__(self,
        ...
        self.conv3x3 = DarknetConv2D_Norm_Activation(in_channels,
                                                     ...
                                                     norm_type=norm_type,
                                                     num_groups=num_groups)
        dbl_clusters = make_DBL_cluster(in_channels * 4,
                                        cluster_num=5,
                                        norm_type=norm_type,
                                        num_groups=num_groups,
                                        sam=sam)
...
class SPP(nn.Module):
    ...
    def make_max_pool_cluster(self, kernel_sizes):
        ...
        for kernel_size in kernel_sizes:
            pad = kernel_size // 2
            clusters.append(nn.MaxPool2d(kernel_size=kernel_size,
                                         stride=1,
                                         padding=pad))
        return clusters
...
class YOLO_SPP(nn.Module):
    ...
    def __init__(self,
        ...
        dbl_cluster_3_1 = make_DBL_cluster(in_channels,
                                           cluster_num=3,
                                           norm_type=norm_type,
                                           num_groups=num_groups)
        ...
        dbl_cluster_3_2 = [
            DarknetConv2D_Norm_Activation(in_channels * 2,
                                          in_channels // 2,
                                          kernel_size=1,
                                          activation='leaky',
                                          norm_type=norm_type,
                                          num_groups=num_groups),
            DarknetConv2D_Norm_Activation(in_channels // 2, in_channels,
                                          kernel_size=3,
                                          activation='leaky',
                                          norm_type=norm_type,
                                          num_groups=num_groups),
            DarknetConv2D_Norm_Activation(in_channels,
                                          in_channels // 2,
                                          kernel_size=1,
                                          activation='leaky',
                                          norm_type=norm_type,
...
class CoordConv(nn.Module):
    ...
    def __init__(self,
                 ...
                 activation='leaky',
                 norm_type='BN',
                 num_groups=None, coord_conv=True):
        ...
        if self.coord_conv:
            ...
            if with_r:
                in_channels += 1
        self.conv = DarknetConv2D_Norm_Activation(in_channels,
                                                  out_channels,
                                                  kernel_size=kernel_size,
