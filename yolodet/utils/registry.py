...
HOOKS = dict(
    FixedLrUpdaterHook='yolodet.hooks.lr_updater_hook.FixedLrUpdaterHook',
    StepLrUpdaterHook='yolodet.hooks.lr_updater_hook.StepLrUpdaterHook',
    ExpLrUpdaterHook='yolodet.hooks.lr_updater_hook.ExpLrUpdaterHook',
    PolyLrUpdaterHook='yolodet.hooks.lr_updater_hook.PolyLrUpdaterHook',
    InvLrUpdaterHook='yolodet.hooks.lr_updater_hook.InvLrUpdaterHook',
    CosineLrUpdaterHook='yolodet.hooks.lr_updater_hook.CosineLrUpdaterHook',
    OptimizerHook='yolodet.hooks.optinizer_hook.OptimizerHook',
    EvalHook='yolodet.hooks.eval_hook.EvalHook',
    DistEvalHook='yolodet.hooks.eval_hook.DistEvalHook',
    CheckpointHook='yolodet.hooks.checkpoint_hook.CheckpointHook',
    TextLoggerHook='yolodet.hooks.logger_hook.TextLoggerHook',
    TensorboardLoggerHook='yolodet.hooks.logger_hook.TensorboardLoggerHook',
    IterTimerHook='yolodet.hooks.iter_timer_hook.IterTimerHook',
)
