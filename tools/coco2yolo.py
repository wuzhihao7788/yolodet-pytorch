...
"""hyper parameters"""
dataDir = '/disk2/project/coco/'
dataType = 'train2017'
json_file_path = '{}/annotations/instances_{}.json'.format(dataDir, dataType)
# json_file_path = 'E:/Dataset/mscoco2017/annotations/instances_train2017.json'
images_dir_path = 'mscoco2017/train2017/'
output_path = '/disk2/project/coco/annotations/train.txt'
...
with open(output_path, 'w') as f:
    for key in tqdm(name_box_id.keys()):
        ...
        for info in box_infos:
            x_min = round(info[0][0])
            y_min = round(info[0][1])
            x_max = x_min + round(info[0][2])
            y_max = y_min + round(info[0][3])
